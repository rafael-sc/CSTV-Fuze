...
class MatchesUseCaseTest {
    ...
    @Test
    fun `useCase returns empty list when repository returns empty list`() = runTest {
        // Given
    ...
    @Test
    fun `useCase returns single match when repository returns single match`() = runTest {
        // Given
    ...
    @Test
    fun `useCase sorts RUNNING matches before NOT_STARTED matches`() = runTest {
        // Given
        ...
        val runningMatch = createTestMatch(
            id = 2,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T12:00:00Z"
        )
        coEvery { matchesRepository.getMatches() } returns flowOf(
            listOf(
                notStartedMatch,
                runningMatch
            )
    ...
    @Test
    fun `useCase sorts RUNNING matches before FINISHED matches`() = runTest {
        // Given
    ...
    @Test
    fun `useCase sorts multiple RUNNING matches by start time ascending`() = runTest {
        // Given
        val runningMatch1 = createTestMatch(
            id = 1,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T12:00:00Z"
        )
        val runningMatch2 = createTestMatch(
            id = 2,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T10:00:00Z"
        )
        val runningMatch3 = createTestMatch(
            id = 3,
            status = MatchStatus.RUNNING,
    ...
    @Test
    fun `useCase sorts multiple NOT_STARTED matches by start time ascending`() = runTest {
        // Given
        val notStartedMatch1 = createTestMatch(
            id = 1,
            status = MatchStatus.NOT_STARTED,
            startTime = "2025-07-20T12:00:00Z"
        )
        val notStartedMatch2 = createTestMatch(
            id = 2,
            status = MatchStatus.NOT_STARTED,
            startTime = "2025-07-20T10:00:00Z"
        )
        val notStartedMatch3 = createTestMatch(
            id = 3,
            status = MatchStatus.NOT_STARTED,
            startTime = "2025-07-20T14:00:00Z"
        )
    ...
    fun `useCase sorts mixed status matches correctly - RUNNING first then by start time`() =
        runTest {
            // Given
            val notStartedEarly = createTestMatch(
                id = 1,
                status = MatchStatus.NOT_STARTED,
                startTime = "2025-07-20T09:00:00Z"
            )
            val runningLate = createTestMatch(
                id = 2,
                status = MatchStatus.RUNNING,
                startTime = "2025-07-20T15:00:00Z"
            )
            val runningEarly = createTestMatch(
                id = 3,
                status = MatchStatus.RUNNING,
                startTime = "2025-07-20T11:00:00Z"
            )
            val notStartedLate = createTestMatch(
                id = 4,
                status = MatchStatus.NOT_STARTED,
    ...
    @Test
    fun `useCase handles matches with same start time and same status`() = runTest {
        // Given
        val match1 = createTestMatch(
            id = 1,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T10:00:00Z"
        )
        val match2 = createTestMatch(
            id = 2,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T10:00:00Z"
        )
    ...
    @Test
    fun `useCase handles large number of matches efficiently`() = runTest {
        // Given
        val matches = (1..100).map { index ->
            createTestMatch(
                id = index,
    ...
    @Test
    fun `useCase preserves all match properties during sorting`() = runTest {
        // Given
        val originalMatch = createTestMatch(
            id = 42,
            status = MatchStatus.RUNNING,
            startTime = "2025-07-20T10:00:00Z",
