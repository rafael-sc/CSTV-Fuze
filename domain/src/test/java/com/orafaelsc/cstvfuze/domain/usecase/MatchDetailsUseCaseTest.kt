...
class MatchDetailsUseCaseTest {
    ...
    @Test
    fun `invoke returns success when repository returns team with players`() = runTest {
        // Given
        val teamId = "123"
        val expectedTeam = createTestTeam(
            id = 123,
            name = "Test Team",
            players = listOf(
    ...
    @Test
    fun `invoke returns success when repository returns team with empty players list`() = runTest {
        // Given
        val teamId = "456"
        val expectedTeam = createTestTeam(
            id = 456,
    ...
    @Test
    fun `invoke handles empty team id correctly`() = runTest {
        // Given
        val teamId = ""
    ...
    @Test
    fun `invoke handles numeric team id as string correctly`() = runTest {
        // Given
        val teamId = "12345"
        val expectedTeam = createTestTeam(
            id = 12345,
    ...
    @Test
    fun `invoke preserves team data integrity`() = runTest {
        // Given
        val teamId = "integrity-test"
        val originalTeam = createTestTeam(
            id = 555,
            name = "Integrity Team",
    ...
    @Test
    fun `invoke handles large team with many players`() = runTest {
        // Given
    ...
    @Test
    fun `invoke handles team with players having null fields`() = runTest {
        // Given
        val teamId = "null-fields"
        val playersWithNulls = listOf(
            createTestPlayer(
                id = 1,
                name = "ValidPlayer",
                firstName = "Valid",
    ...
    @Test
    fun `invoke handles different error types from repository`() = runTest {
        // Given
    ...
    @Test
    fun `invoke passes correct team id to repository`() = runTest {
        // Given
